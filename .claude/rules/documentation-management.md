...
- Update the relevant subfolder file(s) if behavior changed:
  - API changes → `./docs/system/backend/routes.md`, `./docs/system/backend/modules.md`
  - Database changes → `./docs/system/database/*.md` (relevant model file)
  - AI engine changes → `./docs/system/ai-engine/*.md`
  ...
  - Frontend changes → `./docs/system/frontend/*.md`
